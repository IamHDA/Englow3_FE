...
/**
 * Phần khung không đổi của một bước onboarding: nút quay lại, logo, badge số
 * bước, tiêu đề và phụ đề.
 *
    ...
    <Stack gap={0}>
      ...
      <Group justify="center" gap={16} mt={18} wrap="nowrap">
        ...
        <Badge size="lg" radius={10} color="navy.0" c="navy.9" py={16} px={14}>
          Bước {LEARNING_PURPOSE_STEP_NUMBER} / {ONBOARDING_TOTAL_STEPS}
        </Badge>
      </Group>
