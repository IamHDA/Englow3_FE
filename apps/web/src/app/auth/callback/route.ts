...
/**
 * Where the OAuth providers land after Supabase hands the browser back. The
 * PKCE `code` is exchanged for a session here, on the server, so the session
 * cookies are set before anything renders.
 */
