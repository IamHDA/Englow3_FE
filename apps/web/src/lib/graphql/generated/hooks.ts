 ...
 * });
 */
export function useExamPaperQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    ExamPaperQuery,
    ExamPaperQueryVariables
  > &
    (
      { variables: ExamPaperQueryVariables; skip?: boolean } | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useQuery<ExamPaperQuery, ExamPaperQueryVariables>(
    ExamPaperDocument,
    options,
  );
}
export function useExamPaperLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ExamPaperQuery,
    ExamPaperQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return ApolloReactHooks.useLazyQuery<ExamPaperQuery, ExamPaperQueryVariables>(
    ExamPaperDocument,
    options,
  );
}
export function useExamPaperSuspenseQuery(
  baseOptions?: ApolloReactHooks.SuspenseQueryHookOptions<
    ExamPaperQuery,
    ExamPaperQueryVariables
  >,
...
export function useExamPaperSuspenseQuery(
  ...
  return ApolloReactHooks.useSuspenseQuery<
    ExamPaperQuery,
    ExamPaperQueryVariables
  >(ExamPaperDocument, options as any);
}
export type ExamPaperQueryHookResult = ReturnType<typeof useExamPaperQuery>;
export type ExamPaperLazyQueryHookResult = ReturnType<
  typeof useExamPaperLazyQuery
>;
export type ExamPaperSuspenseQueryHookResult = ReturnType<
  typeof useExamPaperSuspenseQuery
>;
export type ExamPaperQueryResult = ApolloReactCommon.QueryResult<
  ExamPaperQuery,
  ExamPaperQueryVariables
>;
